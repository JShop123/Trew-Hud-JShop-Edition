...
window.onload = function () {
		...
		var eventCallback = {
			ui: function(data) {
				...
				if (config.showVipMoney == true) { document.querySelector('#vip_money').style.display = 'block'; }
				...
				if (config.showPoo == true) { document.querySelector('#shit').style.display = 'block'; }
				if (config.showPee == true) { document.querySelector('#pee').style.display = 'block'; }
				if (config.showBath == true) { document.querySelector('#bath').style.display = 'block'; }
				if (config.showGym == true) { document.querySelector('#gym').style.display = 'block'; }
				if (config.showOxygen == true) { document.querySelector('#oxygen').style.display = 'block'; }
			...
			setStatus: function(data) {
				...
				if (data.isdead == true) {
					...
					for (i = 0; i < data.status.length; i++) {
						if ((data.status[i].name == 'hunger') || (data.status[i].name == 'thirst') || (data.status[i].name == 'stress') || (data.status[i].name == 'drunk') || (data.status[i].name == 'shit') || (data.status[i].name == 'pee') || (data.status[i].name == 'bath') || (data.status[i].name == 'gym')) { var statusValue = Math.floor(100 - data.status[i].value); }
